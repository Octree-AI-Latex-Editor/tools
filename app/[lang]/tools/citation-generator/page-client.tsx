...
interface CitationGeneratorClientProps {
  dict: Dictionary;
  lang: Locale;
}
...
export default function CitationGeneratorClient({ dict, lang }: CitationGeneratorClientProps) {
  ...
  const locale = lang;
  const cit = dict.toolsSpecific.citationGenerator as Record<string, string>;
      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="mb-12">
          <div className="relative flex items-start justify-center mb-3">
            ...
            <h1 className="text-4xl font-light text-gray-900">{cit.title}</h1>
          </div>
                  ...
                  activeTab === 'code' ? (
                    ...
                    <div className="flex-1 overflow-auto rounded-lg">
                      {isCompiling ? (
                        ...
                        <div className="flex items-center justify-center h-full">
                          <p className="text-gray-400">{dict.tools.previewWillAppear}</p>
                        </div>
                      )}
                    </div>
                  )
