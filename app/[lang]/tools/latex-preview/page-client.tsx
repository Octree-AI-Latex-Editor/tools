...
interface LatexPreviewClientProps {
  dict: Dictionary;
  lang: Locale;
}
...
export default function LatexPreviewClient({ dict, lang }: LatexPreviewClientProps) {
  ...
  const locale = lang;
  const preview = dict.toolsSpecific.latexPreview as Record<string, string>;
      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="mb-12">
          <div className="relative flex items-start justify-center mb-3">
            ...
            <h1 className="text-4xl font-light text-gray-900">{preview.title}</h1>
          </div>
          <p className="text-lg text-gray-600 text-center">{preview.description}</p>
        </div>
          ...
          <div className="flex flex-col">
            <div className="h-[72px] mb-6 flex flex-col justify-start">
              <div className="mb-2 flex items-center gap-3">
                ...
                <h2 className="text-xl font-medium text-gray-900">{preview.latexEditor}</h2>
              </div>
          ...
          <div className="flex flex-col">
            <div className="h-[72px] mb-6 flex flex-col justify-start">
              <div className="mb-2 flex items-center gap-3">
                ...
                <h2 className="text-xl font-medium text-gray-900">{preview.pdfOutput}</h2>
              </div>
              <p className="text-sm text-gray-600">
            ...
            {previewUrl && (
              <div className="mt-6">
                <button
                  onClick={() => openInOctree({ latex: latexCode, title: preview.title, source: 'tools:preview' })}
